...
#from apps.products.api.views.general_views import MeasureUnitListAPIView, IndicatorUnitListAPIView, CategoryProductListAPIView
...
urlpatterns = [
    ...
    #path('product_retrieve_update_destroy/<int:pk>/', ProductRetrieveUpdateDestroyAPIView.as_view(),name='product_retrieve_update_destroy')

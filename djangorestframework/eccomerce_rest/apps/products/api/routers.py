...
from apps.products.api.views.general_views import MeasureUnitViewSet, IndicatorUnitViewSet, CategoryProductViewSet
...
router.register(r'indicators', IndicatorUnitViewSet, basename="indicators")
